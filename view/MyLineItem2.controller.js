sap.ui.controller("sap.ui.demo.myFiori.view.MyLineItem2", {
/*
	onInit : function() {
    ...
    onBeforeRendering: function() {
    	...
    	oView.byId("idCustomerID").mProperties.editable  = false;
    	oView.byId("idAgency").mProperties.editable      = false;
    	oView.byId("idPassenger").mProperties.editable   = false;
    	oView.byId("Booking").mProperties.visible        = false;
    	oView.byId("TemplateUpdate").mProperties.visible = false;
    	oView.byId("TemplateDelete").mProperties.visible = false;
    },	
